...
//  颜色配置 
const firstLevel = ['#da0d68','#da1d23','#ebb40f','#187a2f','#0aa3b5','#c94930','#ad213e','#a87b64','#e65832'];//9
const secondLevel= [
...
const thirdLevel= [
                    ['#f99e1c','#ef5a78','#f7f1bd','#f68a5c','#baa635','#f26355','#e2631e','#fde404'],//3
                    ['#3e0317','#e62969','#6569b0','#ef2d36','#b53b54','#a5446f','#f2684b','#e73451'],//18
                    ['#9ea718','#94a76f','#d0b24f','#8eb646','#faef07','#c1ba07','#8f1c53','#b34039'],//10
                    ['#a2bb2b','#62aa3c','#03a653','#038549','#28b44b','#a3a830','#7ac141','#8b6439'],//7
                    ['#8b8c90','#beb276','#fefef4','#744e03','#a3a36f','#c9b583','#978847','#9d977f'],//16
                    ['#b9a449','#899893','#a1743b','#894810','#b7906f','#eb9d5f','#f89a1c','#aeb92c'],//6
                    ['#c78936','#8c292c','#e5762e','#a16c5a','#80a89d','#def2fd','#7a9bae','#039fb8'],//4
                    ['#d4ad12','#9d5433','#c89f83','#692a19','#470604','#db646a','#120c0c','#cc7b6a'],//5
                    ['#310d0f','#ae341f','#d78823','#da5c1f','#7eb138','#e65656','#ba9232','#4eb849'],//4
                  ];              
            ...
            if(treemap.treemap[i].data[j].children[k].children) {
              for(let l= 0; l< treemap.treemap[i].data[j].children[k].children.length; l++) {
                  if(j < firstLevel.length && k < secondLevel[0].length && l < thirdLevel[0].length) {
                    treemap.treemap[i].data[j].children[k].children[l].itemStyle = {
                      color:thirdLevel[k][l]
                    }
                  }else {
                     treemap.treemap[i].data[j].children[k].children[l].itemStyle = {
                      color:thirdLevel[parseInt((thirdLevel.length)*Math.random())][parseInt((thirdLevel[0].length)*Math.random())]
                     }
                  }
              }
            }                        
